...
import Pract1SD.RabbitMQ.insult_filter_client as insult_filter_client  # Asegúrate de que se importa correctamente
...
def start_angry_producer(client_id, results):
    ...
    while time.time() - start_time < DURATION:
        ...
        insult_filter_client.run_for_duration(DURATION)  # Ajustado para enviar texto durante un tiempo limitado
